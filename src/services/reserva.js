...
async function getReservasByDNICliente(dni){
    try{
    const res = await axiosBase.get('/reservas/cliente/' + dni)
    return res.data
    }catch(error){
        throw error
    }
}
async function getReservasConsulta(dni){
    try{
    const res = await axiosBase.get('/reservas/consultar' )
    return res.data
    }catch(error){
        throw error
    }
}
async function getReservaByCodigoConfirmacion(codigo){
    try{
    const res = await axiosBase.get('/reservas/codigo/' + codigo)
    return res.data
    }catch(error){
        throw error
    }
...
export {transaccionReserva, cancelarReserva, getReservasByDNICliente, getReservasConsulta, getReservaByCodigoConfirmacion};